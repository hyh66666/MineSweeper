...
public class Login extends JFrame implements ActionListener {
    ...
    public static int playerPhotoNumber1 = 0;
    public static int playerPhotoNumber2 = 0;
...
/*    public static void costrest() {
    ...
    public Login() {
        ...
        JButton con1 = new JButton("查看技能");
        JButton con2 = new JButton("查看技能");
        JButton nex1 = new JButton("换个角色");
        JButton nex2 = new JButton("换个角色");

        con1.addActionListener(e -> {
            switch (playerPhotoNumber1) {
                case 0:
        ...
        con2.addActionListener(e -> {
            switch (playerPhotoNumber2) {
                case 0:
                    JOptionPane.showMessageDialog(null, "如果每个回合的第一次点击进行了正确的标记，那么额外获得一分。", "开门大吉", JOptionPane.PLAIN_MESSAGE);
                    break;
                case 1:
        ...
        load.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    fileIn.close();
                    setVisible(false);
                    MainFrame mainFrame = new MainFrame(player1, player2, save.xCount, save.yCount, save.mineCount, save);

                    MainFrame.playerPhoto2 = save.player2.picture;
                    MainFrame.playerPhoto1 = save.player1.picture;
                    MainFrame.seconds = save.time;
        ...
        diff.addActionListener(new ActionListener() {
            ...
            private void mineCustomize() {
                ...
                Login.xCount = Integer.parseInt(JOptionPane.showInputDialog(null, "输入雷区的高度", "Input", JOptionPane.PLAIN_MESSAGE));        //输入对话框
                Login.yCount = Integer.parseInt(JOptionPane.showInputDialog(null, "输入雷区的宽度", "Input", JOptionPane.PLAIN_MESSAGE));        //输入对话框
                Login.mineCount = Integer.parseInt(JOptionPane.showInputDialog(null, "输入雷数，不能大于棋子数的一半", "Input", JOptionPane.PLAIN_MESSAGE));//输入对话框
                Login.n = Integer.parseInt(JOptionPane.showInputDialog(null, "每回合可以点击的次数，不能大于5", "Input", JOptionPane.PLAIN_MESSAGE));//输入对话框
                if (n > 5 || Login.xCount > 24 || Login.yCount > 30 || Login.mineCount > (Login.xCount * Login.yCount) / 2) {
...
//            }
            ...
            MainFrame.playerPhoto1 = playerPhotoNumber1;
            MainFrame.playerPhoto2 = playerPhotoNumber2;
            this.setVisible(false);
            MainFrame mainFrame = new MainFrame(player1, player2, xCount, yCount, mineCount, save);
