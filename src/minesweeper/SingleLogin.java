    ...
    public SingleLogin() {
        ...
        load.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    in.close();
                    fileIn.close();
                    SingleMainFrame SingleMainFrame = new SingleMainFrame(player1, player2, save.xCount, save.yCount, save.mineCount, save);
                    SingleMainFrame.playerPhoto2 = save.player2.picture;
                    SingleMainFrame.playerPhoto1 = save.player1.picture;
                    SingleMainFrame.seconds = save.time;
                } catch (IOException i) {
                    i.printStackTrace();
                    return;
        ...
        diff.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                switch (info) {
                    case "简单-双人":
                        SingleLogin.xCount = 9;
                        SingleLogin.yCount = 9;
                        SingleLogin.mineCount = 10;
                        n = 3;
                        break;
                    case "中等-双人":
                        SingleLogin.xCount = 16;
                        SingleLogin.yCount = 16;
                        SingleLogin.mineCount = 40;
                        n = 4;
                        break;
                    case "困难-双人":
                        SingleLogin.xCount = 16;
                        SingleLogin.yCount = 30;
                        SingleLogin.mineCount = 99;
                        n = 5;
                        break;
                    case "自定义-双人":
                        mineCustomize();
            ...
            private void mineCustomize() {
                ...
                SingleLogin.xCount = Integer.parseInt(JOptionPane.showInputDialog(null, "输入雷区的高度", "Input", JOptionPane.PLAIN_MESSAGE));        //输入对话框
                SingleLogin.yCount = Integer.parseInt(JOptionPane.showInputDialog(null, "输入雷区的宽度", "Input", JOptionPane.PLAIN_MESSAGE));        //输入对话框
                SingleLogin.mineCount = Integer.parseInt(JOptionPane.showInputDialog(null, "输入雷数，不能大于棋子数的一半", "Input", JOptionPane.PLAIN_MESSAGE));//输入对话框
                SingleLogin.n = Integer.parseInt(JOptionPane.showInputDialog(null, "每回合可以点击的次数，不能大于5", "Input", JOptionPane.PLAIN_MESSAGE));//输入对话框
                if (n > 5 || SingleLogin.xCount > 24 || SingleLogin.yCount > 30 || SingleLogin.mineCount > (SingleLogin.xCount * SingleLogin.yCount) / 2) {
...
//            }
            ...
            SingleMainFrame.playerPhoto1 = playerPhotoNumber1;
            SingleMainFrame.playerPhoto2 = playerPhotoNumber2;
            this.setVisible(false);
            SingleMainFrame SingleMainFrame = new SingleMainFrame(player1, player2, xCount, yCount, mineCount, save);
            SingleMainFrame.setVisible(true);
//            this.setVisible(false);
